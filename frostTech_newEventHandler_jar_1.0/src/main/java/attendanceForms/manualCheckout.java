...
String fullName, event;
    ...
    public void displayTable() {
      ...
      try {
        ...
        while (rs.next()) {
          ...
          row.add("Time Out"); // Use text instead of JButton for initial rendering
        ...
        table.getColumn("Time Out").setCellRenderer(new manualCheckout.ButtonRenderer());
        table.getColumn("Time Out").setCellEditor(new manualCheckout.ButtonEditor(new JCheckBox()));
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            try {
              ...
              if (resultSet.next()) {
                ...
                if (rowsAffected > 0) {
                  JOptionPane.showMessageDialog(null, fullName + "Timed out Successfully", "Time out Status", JOptionPane.INFORMATION_MESSAGE);

                } else {
                 JOptionPane.showMessageDialog(null, fullName+" Student already Timed out", "Time out Status", JOptionPane.WARNING_MESSAGE);

                }

              } else {
       
             JOptionPane.showMessageDialog(null, fullName+" Student is Not Registered", "Time out Status", JOptionPane.WARNING_MESSAGE);
              }
    ...
    public manualCheckout(int i, String eventName,String user) {
      username = user;
      event=eventName;
