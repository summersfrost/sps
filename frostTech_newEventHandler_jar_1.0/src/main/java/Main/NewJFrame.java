...
public static String saveImage(byte[] img) {
    ...
    try {
        ...
        // Insert the image into the logo table
        insertPs = conn.prepareStatement("INSERT INTO logo(logo) VALUES (?)");
        insertPs.setBytes(1, img);
        ...
        status = "An error occurred while saving the image.";
    } finally {
        // Close all resources
        try {
            if (insertPs != null) {
